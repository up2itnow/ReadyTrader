...
from execution.coinbase_user_stream import CoinbaseUserStreamManager
from execution.kraken_user_stream import KrakenUserStreamManager
...
class Container:
    def __init__(self):
        ...
        # Exchange-specific user stream managers
        self.binance_user_streams = BinanceUserStreamManager(metrics=self.metrics)
        self.kraken_user_streams = KrakenUserStreamManager(metrics=self.metrics)
        self.coinbase_user_streams = CoinbaseUserStreamManager(metrics=self.metrics)
